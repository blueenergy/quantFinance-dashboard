<template>
  <div class="strategy-lab">
    ...
    <StrategyLabLoopPanel
      v-model:expanded="loopPanelExpanded"
      v-model:pending-delete-loop="pendingDeleteLoop"
      :loop-health-status-text="loopHealthStatusText"
      :loop-health="loopHealth"
      :loop-form="loopForm"
      :loop-submitting="loopSubmitting"
      :loop-message="loopMessage"
      :can-start-loop-from-batch="canStartLoopFromBatch"
      :start-loop-from-batch-hint="startLoopFromBatchHint"
      :loops="loops"
      :selected-loop-id="selectedLoopId"
      :selected-loop="selectedLoop"
      :can-manage-active-loop="canManageActiveLoop"
      :can-advance-loop="canAdvanceLoop"
      :can-delete-selected-loop="canDeleteSelectedLoop"
      :loop-summary="loopSummary"
      :loop-summary-loading="loopSummaryLoading"
      :start-auto-loop="startAutoLoop"
      :start-auto-loop-from-batch="startAutoLoopFromBatch"
      :refresh-selected-loop="refreshSelectedLoop"
      :select-loop="selectLoop"
      :pause-selected-loop="pauseSelectedLoop"
      :resume-selected-loop="resumeSelectedLoop"
      :cancel-selected-loop="cancelSelectedLoop"
      :advance-selected-loop="advanceSelectedLoop"
      :delete-selected-loop="deleteSelectedLoop"
      :confirm-delete-selected-loop="confirmDeleteSelectedLoop"
      :request-loop-final-report="requestLoopFinalReport"
      :select-batch="selectBatch"
      :loop-step-label="loopStepLabel"
